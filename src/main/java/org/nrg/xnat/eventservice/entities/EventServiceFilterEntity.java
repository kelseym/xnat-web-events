...
public class EventServiceFilterEntity {
    ...
    private static final TypeReference<HashMap<String, JsonPathFilterNode>> TYPE_REF_MAP_STRING_FILTER_NODE      = new TypeReference<HashMap<String, JsonPathFilterNode>>() {};
        ...
        if (eventServiceFilter != null){
            if(eventServiceFilter.nodeFilters() != null && !eventServiceFilter.nodeFilters().isEmpty()){
                try {
                    ...
                    eventServiceFilterEntity.setNodeFilterJson(nodeFilterJson);
